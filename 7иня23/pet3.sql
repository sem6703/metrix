...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 06 2023 г., 08:37
...
--
-- AUTO_INCREMENT для таблицы `grz`
--
ALTER TABLE `grz`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT для таблицы `koys`
--
ALTER TABLE `koys`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
