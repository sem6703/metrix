...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 12 2023 г., 17:38
...
INSERT INTO `gru` (`id`, `ima`, `phote`, `txt`, `use`) VALUES
(1, 'бык', 1, 'Стихия, которая покровительствует Быку, может смягчать или усиливать его качества. Всего в восточном гороскопе пять стихий, у каждой свой характер и преимущества (огонь, вода, металл, дерево, земля). Бык — символ трудолюбия и выносливости, терпения и упорства.', 1),
(2, 'дракон', 2, 'Дракон, также известный как Лунг, является пятым из 12-летнего цикла животных, которые появляются в китайском зодиаке, связанном с китайским календарем. Год Дракона связан с символом Земной Ветви', 2),
(3, 'заяц', 3, 'Представитель этого знака Китайского гороскопа отличается такими чертами характера: чувствительный, сострадательный, нежный, милосердный, скромный, упрямый, консервативный, робкий', 2),
(4, 'змкя', 4, 'Представитель этого знака Китайского гороскопа отличается такими чертами характера: черты характера: отзывчивый, страстный, умный, подозрительный, хитрый, ревнивый, неаккуратный.', 1),
(5, 'крыса', 5, 'Наиболее удачливой порой для этого животного является зима. Пик везения приходится на декабрь. Элемент Крысы - вода. Если рассматривать этот знак в сочетании с европейским Зодиаком, то можно увидеть его соответствие со Стрельцом, потому счастливыми цветами Крысы считаются чёрный и красный.', 2),
(6, 'лошадь', 6, 'отличается такими чертами характера: искренность, энтузиазм, общительность, уступчивость, разговорчивость, чувство юмора, благородство, энергичность, расточительность, вспыльчивость, наивность, безответственность, неуверенность, неуравновешенность, противоречивость, самолюбие.', 2),
(7, 'обезяна', 7, 'отличается такими чертами характера: восторженный, уверенный в себе, общительный, ревнивый, подозрительный, хитрый, эгоистичный, высокомерный.', 1),
(8, 'овца', 8, 'внимательный, отзывчивый, настойчивый, трудолюбивый, привлекательный, бережливый, безвольный, робкий, капризный, пессимистичный, нерешительный.', 1),
(9, 'петух', 9, 'независимый, способный, сердечный, уважающий себя, сообразительный, нетерпеливый, критический, эксцентричный, ограниченный, эгоистичный.', 3),
(10, 'свинья', 10, 'добросердечность, вспыльчивость, верность, честность, нежность, наивность, доверчивость, вялость и вспыльчивость.', 1),
(11, 'собака', 11, 'доблестный, верный, ответственный, умный, чувствительный, консервативный, упрямый, эмоциональный смелый, живой.', 1),
(12, 'тигр', 12, 'Тигры бывают очень чувствительными, постоянно о чем-то размышляют, поэтому порой проявляют раздражительность.', 1),
(13, 'Агути', 13, 'свинки породы агути отличаются безудержным свободолюбием и тягой к дикой природе. Они спокойно могут существовать на вольном выпасе – только летом, конечно! А если свинка агути спрячется в траве, вы вообще ее не найдете. Если только она сама не захочет.', 0);
